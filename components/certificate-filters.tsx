        ...
        <DropdownMenuTrigger asChild>
          <Button variant="outline" size="sm" className="h-8 gap-1 bg-transparent">
            ...
            {expirationFilter !== "all" && (
              <Badge className="h-5 px-1 ml-1">{getExpirationLabel(expirationFilter)}</Badge>
            )}
        ...
        <DropdownMenu open={isIssuerOpen} onOpenChange={setIsIssuerOpen}>
          <DropdownMenuTrigger asChild>
            <Button variant="outline" size="sm" className="h-8 gap-1 bg-transparent">
              <Filter className="h-3.5 w-3.5" />
              Issuer
              {issuerFilter && <Badge className="h-5 px-1 ml-1">1</Badge>}
              <ChevronDown className="h-3.5 w-3.5 opacity-50" />
            </Button>
          </DropdownMenuTrigger>
      ...
      <DropdownMenu open={isSortOpen} onOpenChange={setIsSortOpen}>
        <DropdownMenuTrigger asChild>
          <Button variant="outline" size="sm" className="h-8 gap-1 bg-transparent">
            <Filter className="h-3.5 w-3.5" />
            Sort
            {sortOption !== "expiration-asc" && <Badge className="h-5 px-1 ml-1">1</Badge>}
            <ChevronDown className="h-3.5 w-3.5 opacity-50" />
          </Button>
        </DropdownMenuTrigger>
        <DropdownMenuContent align="start" className="w-56">
